...
public class SendMessServlet extends HttpServlet {
	...
	private static final String ACCOUNT_SID = "aa1959e2ee8e4607b8e77d13cc88f958";
	private static final String AUTH_TOKEN = "a5de25d2a4b94e1098ab5be4df9bd2d2";
	private String rod = "123";//smsCode();// ;
		...
		try {
			...
			if (check.equals("1")) {
				...
				if (!mess.equals(rod)) {
					...
					response.getWriter().print("{\"msg\":\"正确\"}");
				}
